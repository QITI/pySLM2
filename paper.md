...
The arithmic operations of the profiles are also overloaded, so one can easily combine different profiles through addition or rescale the proviles through multiplication. Shown in Fig. \autoref{fig:multi}
